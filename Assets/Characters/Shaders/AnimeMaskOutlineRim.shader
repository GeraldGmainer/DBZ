...
Shader "Psyren/AnimeMaskOutlineRim"{
	Properties {
		...
		_RimColor ("Rim Color", Color) = (0.9,0.9,0.9,0.0)
      	_RimPower ("Rim Power", Range(0.5,100.0)) = 2.0
	}
	...
	SubShader {
		...
		void surf (Input IN, inout ToonSurfaceOutput o) {
			...
			o.Color = (mask.b*_BlueColor + mask.g*_GreenColor + mask.r*_RedColor);
			o.Albedo = o.Color.rgb * 1.0f;
